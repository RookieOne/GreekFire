...
namespace GreekFire.Foundation.ExpressionVisitors
{
    /// <summary>
    /// Abstract class based provided by Microsoft that implements the
    /// visitor pattern allowing modification of an ExpressTree
    /// </summary>
